...
namespace HumanResources.AppLogic.Tests
{
    public class EmployeeServiceTests : TestBase
    {
        ...
        private Mock<IPublishEndpoint> _publishEndpointsMock;
        ...
        public void Setup()
        {
            ...
            _publishEndpointsMock = new Mock<IPublishEndpoint>();

            _service = new EmployeeService(_employeeFactoryMock.Object, _employeeRepositoryMock.Object, _publishEndpointsMock.Object);
        }
